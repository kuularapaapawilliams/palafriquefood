...
from .forms import VendorForm, OpeningHourForm, OpeningHour
...
def add_food(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save()
            messages.success(request, 'FoodItem is Added Successfully!')
...
def edit_food(request, pk=None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            food.slug = slugify(foodtitle)
            form.save()
            messages.success(request, 'FoodItem is Updated Successfully!')
            return redirect('fooditems_by_category', food.category.id)
        else:
            print(form.errors)
    else:
